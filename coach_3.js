...
// https://calendly.com/lin-welcome-team/lin-medical-intake-appointment?embed_domain=lin-health-app.webflow.io&embed_type=Inline&utm_medium=intake&utm_term=f&phone_number=(201)%20777-1717&name=Harel%20Lin%20Health&email=h%40p.com&a2=%2B12017771717
const hunter_base =
  "https://calendly.com/lin-welcome-team/lin-medical-intake-appointment?utm_medium=intake&utm_term=f";
const normal_base =
  "https://calendly.com/lin-welcome-team/intake-consultation?utm_medium=intake&utm_term=f";
...
submit_user_info.addEventListener("click", (event) => {
  ...
  if (!executed2) {
    ...
    checkState();
    createCalendly(
      `${normal_base}&phone_number=${phone.value}`,
    ...
    createCalendlyHunter(
      `${hunter_base}&phone_number=${phone.value}`,
      `${first_name.value} ${last_name.value}`,
      email.value,
      `${
        document.querySelector(".iti__selected-dial-code").innerHTML
